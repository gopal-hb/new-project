                        ...
                        <table id="addressTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $cate->address }}</td>
                                    <td>
                                        <button class="btn btn-success btn-sm" onclick="editaddress({{ $cate }})" data-bs-toggle="modal" data-bs-target="#editaddress">Edit</button>
                                        <form action="{{ route('address.destroy', $cate->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
