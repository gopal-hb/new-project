                        ...
                        <table id="LocationTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $Loc->location }}</td>
                                    <td>
                                        <button class="btn btn-success btn-sm" onclick="editlocation({{ $Loc }})" data-bs-toggle="modal" data-bs-target="#editlocation">Edit</button>
...
<script>
     function editlocation(Loc) {
        $('#locationedit').attr('action', '/location/' + Loc.id);
